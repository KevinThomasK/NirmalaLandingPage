...
export const services2 = [
  {
    ...
    text: "Business Analytics is the process of using data analysis, statistical models, and technology to inform business decisions and drive outcomes.",
    categories: [
      "BSc/MSc In Business Analytics",
      "BSc/MSc In Fincancial Analytics",
      "BSc/MSc in Supply Chain Analytics",
    ],
    delay: "0s",
  ...
  },
  {
    ...
    text: "Pharmacy courses focus on the study of medicinal drugs, their preparation, and their effects on the human body, preparing students for careers in healthcare and pharmaceuticals.",
    categories: ["BSc Pharmacy", "MPharm Pharmacy", "BSc (Hons) Pharmacology"],
    delay: "0.15s",
  ...
  },
  {
    ...
    title: "Engineering",
    text: "Engineering is the application of scientific principles and mathematical techniques to design, develop, and innovate solutions for real-world problems in various industries.",
    categories: [
  ...
  },
  {
    ...
    text: "Hospitality and Tourism encompass the management and delivery of services in the travel, lodging, and entertainment sectors, focusing on enhancing the guest experience and promoting sustainable tourism practices.",
    categories: [
